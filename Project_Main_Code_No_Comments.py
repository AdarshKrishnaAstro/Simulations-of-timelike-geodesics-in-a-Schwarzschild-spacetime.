...
print('\nThis is a program to simulate the trajectory of a particle with mass(m) in the vicinity of a Schwarzschild black hole.\n')  
...
def trajectory(input_file : str, output_file : str):
    ...
    if L==0:
        print("Particle is radially falling into the black hole.\n")
    r_values = X.y[1]
    phi_values = X.y[2]
    ...
    event_horizon_radius = 2 * float(M)  
